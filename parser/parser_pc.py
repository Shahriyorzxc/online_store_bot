...
def get_content(html):
    ...
    for product in product_block:
        ...
        configurations = product.find("h5")
        try:
            configurations = configurations.get_text(strip=True)
        except:
...
class Parser_computer:
    def __init__(self):
        self.URL = 'https://pcmarket.uz/cat/kompyutery/'
    ...
    def run(self):
        ...
        for data in content:
            PostgreSql_computer().insert_data(*data.values())
